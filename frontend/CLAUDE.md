...
- **`docs/`** — design specs and plans under `docs/superpowers/`, backend handoffs under `docs/handoff/`, deploy runbooks, QA plans. See `docs/README.md` for the taxonomy. Run brainstorming/planning from this directory so new specs land here.
