// Mirrors MyProjectsList: the toolbar row, a three-column card grid with the
// same 16:9 media block and text rhythm, and the paginator — so the page
// doesn't shift when the real list streams in.
export function MyProjectsListSkeleton({ cards = 6 }: { cards?: number }) {
  return (
