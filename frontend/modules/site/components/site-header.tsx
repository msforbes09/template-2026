...
// Logo lockup + minimal nav. Auth stays session-aware via SiteHeaderAuthArea (Suspense). Nav
...
// Matches SiteHeaderNav's dimensions (desktop nav links + auth area +
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between px-6 py-4 sm:px-9 lg:px-16">
        <Link href="/" className="flex items-center" aria-label={`${env.NEXT_PUBLIC_APP_NAME}, home`}>
