...
// Not in maintenance. This is what an unreachable, empty or
// malformed flag map resolves to, and the direction of that failure is a
// decision worth stating rather than an accident.
//
// FAILING OPEN. A blip on one endpoint must not throw the whole site behind
// a maintenance page nobody asked for.
//
...
// The wire shape is `{ "maintenance_mode": 1 }` — 1/0, like every other boolean
