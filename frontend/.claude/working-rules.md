...
4. **The backend source is the contract.** Read the real routes, Form Requests
   and API Resources under `backend/project/` and build against what they
   return; there is no handoff document.
