...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'session_inactivity_minutes', type: 'integer', example: 60, description: 'Profile only; the idle window after which the server expires the session'),
        new OA\Property(property: 'token_expires_at', type: 'string', nullable: true, example: '2026-07-04 11:30:00', description: 'Profile only; when the current session expires if no further request slides it'),
