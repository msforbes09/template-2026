...
class ChangePasswordController extends Controller
{
    ...
    #[OA\Post(
        ...
        description: 'Verifies the current password and sets a new one (which must differ). Revokes all existing tokens and returns a fresh one.',
        security: [['bearerAuth' => []]],
        tags: ['Password'],
        ...
        responses: [
            ...
            new OA\Response(response: 422, description: 'Validation error (wrong current, weak or unchanged new password)', content: new OA\JsonContent(ref: '#/components/schemas/ValidationError')),
