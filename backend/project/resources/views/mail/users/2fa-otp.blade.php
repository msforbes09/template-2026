...
@section('body')
    <x-mail-body>
        ...
        <x-slot:content>
            ...
            <p style="line-height: 150%">Use the One-Time Password (OTP) below to finish signing in to your {{ config('app.name') }} account.</p>
            <p style="line-height: 150%">&nbsp;</p>
            ...
            <p style="line-height: 150%">&nbsp;</p>
            <p style="line-height: 150%">This code expires shortly. If you didn't try to sign in, you can safely ignore this email — and consider changing your password.</p>
            <p style="line-height: 150%">&nbsp;</p>
