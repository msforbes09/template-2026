...
4. **Cross-cutting work lands in the same PR.** When an item changes the API
   contract, the matching `frontend/` change is part of the same todo item, made
   after the backend tests are green. No handoff document.
